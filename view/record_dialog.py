...
class RecordDialog(QDialog):
    def __init__(self, parent=None, available_formats=None, available_writers=None):
        ...
        # Découverte dynamique des formats pour les enregistrés dans AFormat
        AFormat.discover_formatters('utils.formatter')

        # Découverte dynamique des writters pour les enregistrés dans AWritter
        AWritter.discover_writters('utils.writter')

        # Initialisation des options
        self.available_formats = available_formats or AFormat.get_available_formats()
        self.available_writers = available_writers or AWritter.get_available_writter()
