...
class SimulationDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.available_readers = AReader.get_available_readers()
        self.available_formats = AFormat.get_available_formats()
        self.available_simulation = ["DYNAMIC", "FROM DATA"]
        ...
        simulation_label = QLabel("Simulation type")
        self.simulation_combox = QComboBox()
        self.format_combobox.addItems(self.available_simulation)
        simulation_layout.addWidget(self.simulation_combox)
