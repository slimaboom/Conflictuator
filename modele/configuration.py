...
AIRCRAFTS.add_aircraft(Aircraft(speed=0.0001, 
                                flight_plan=Airway.transform(ROUTES.get_from_key("NO-SE1"), BALISES), flight_plan_timed = {})
                    )
AIRCRAFTS.add_aircraft(Aircraft(speed=0.0002, 
                                flight_plan=Airway.transform(ROUTES.get_from_key("NO-SO1"), BALISES, reverse=True), flight_plan_timed={})
)
AIRCRAFTS.add_aircraft(Aircraft(speed=0.00015, 
                                flight_plan=Airway.transform(ROUTES.get_from_key("SE-NE1"), BALISES,), flight_plan_timed={})
)
